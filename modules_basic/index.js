module.exports = {
  ...
  message: {
    author:    require('./message/author.js'),
    backlinks: require('./message/backlinks.js'),
    link:      require('./message/link.js'),
    name:      require('./message/name.js'),
    render:    require('./message/render.js'),
  },
